    ...
    $.get("sermonDate.php", function(jsonObj) {
        ...
        for (let i = 0; i < $(jsArr).length; i++) {
            ...
            if (jsArr[i]["dateOf"].getFullYear() == holdDate) {
                    ...
                    $("#" + holdDate + i).children("div.card-body").append('<h4 class = "card-title text-primary"><a href = "openSermon.html?id=' + jsArr[i]["sermonId"] + '" class = "text-decoration-none">' + jsArr[i]["title"] + '</a></h4>');
