$(function() {
    $.get("index2.php", function(jsonObj) {
        ...
        for (let i = 0; i < $(jsArr).length; i++) {
            $(".card-columns").append('<a href = "openSermon.html?sermonId=' + jsArr[i]["sermonId"] + '" class = "text-decoration-none text-dark"><div class = "card bg-light border-0 rounded-0" id = "' + i + '"></div></a>');
