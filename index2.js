    ...
    $.get("index2.php", function(jsonObj) {
        ...
        for (let i = 0; i < $(jsArr).length; i++) {
            ...
            if (jsArr[i]["vidLink"]) {
                ...
                $("#" + i).children("div.card-body").append('<div class = "position-relative text-dark"><img class = "card-img-bottom" src = "https://img.youtube.com/vi/' + jsArr[i]["vidLink"] + '/hqdefault.jpg"><a id = "vid' + i + '" href = "openSermon.html?sermonId=' + jsArr[i]["sermonId"] + '" class = "position-absolute"><i class="fas fa-play fa-2x"></i></a></div>');
                $("#vid" + i).css({"bottom":"45%", "left":"45%"});
            }
            else {
                $("#" + i).children("div.card-body").append('<div class = "position-relative text-dark"><img class = "my-1 img-fluid card-img-bottom" src = "images/scans/' + jsArr[i]["imgLink"] + 'a.jpg"><a id = "img' + i + '" href = "openSermon.html?sermonId=' + jsArr[i]["sermonId"] + '" class = "position-absolute"><i class="fas fa-images fa-2x"></i></a></div>');
