...
$(function() {
    $.get("justDate.php", function(jsonObj) {
        ...
        $("#allYears").append('<div class = "card bg-light rounded-0 col-md-4 border-0 p-0 my-3" id = "' + holdDate + '"><a href = "sermonDate.html#' + holdDate + '" class = "text-dark text-decoration-none"></div>');
