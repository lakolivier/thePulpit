...
$(function() {
    $.get("justDate.php", function(jsonObj) {
        ...
        $("#allYears").append('<div class = "card bg-white rounded-0 col-md-4 border-0 p-0 my-3" id = "' + holdDate + '"></div>');
        $("#" + holdDate).append('<a href = "sermonDate.html#' + holdDate + '" class = "text-dark text-decoration-none"><h2 class = "card-title hovElement m-0 px-3 py-1">' + holdDate + "</h2></a>");
        for (let i = 1; i < $(jsArr).length; i++) {
            ...
            $("#" + lastDate).after('<div class = "card bg-white rounded-0 col-md-4 border-0 p-0 my-3" id = "' + holdDate + '"></div>');
            $("#" + holdDate).append('<a href = "sermonDate.html#' + holdDate + '" class = "text-dark text-decoration-none"><h2 class = "card-title hovElement m-0 px-3 py-1">' + holdDate + "</h2></a>");
            lastDate = holdDate;
        }
    });
