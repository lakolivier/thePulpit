$(function() {
    $.get("justTags.php", function(jsonObj) {
        ...
        let lastTag = trimTag;
        $("#allTags").append('<div class = "card rounded-0 col-8 my-3 border-0 mx-auto" id = "' + trimTag + '"></div>');
        ...
        for (let i = 1; i < $(jsArr).length; i++) {
            ...
            $("#" + lastTag).after('<div class = "card rounded-0 col-8 my-3 border-0 mx-auto" id = "' + trimTag + '"></div>');
