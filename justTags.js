$(function() {
    $.get("justTags.php", function(jsonObj) {
        ...
        $("#" + trimTag).append('<h2 class = "card-title m-0 hovElement"><a href = "sermonTags.html#' + trimTag + '" class = "text-dark text-decoration-none">' + jsArr[0]["tagName"] + '</a></h2>');
        for (let i = 1; i < $(jsArr).length; i++) {
            ...
            $("#" + trimTag).append('<h2 class = "card-title m-0 hovElement"><a href = "sermonTags.html#' + trimTag + '" class = "text-dark text-decoration-none">' + jsArr[i]["tagName"] + '</a></h2>');
            lastTag = trimTag;
        }
    });
});