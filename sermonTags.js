    ...
    $.get("sermonTags.php", function(jsonObj) {
        ...
        for (let i = 0; i < $(jsArr).length; i++) {
            ...
            if (jsArr[i]["tagName"].replace(/\s/g, "") == trimTag) {
                    $("#" + trimTag).append('<a href = "openSermon.html?sermonId=' + jsArr[i]["sermonId"] + '" class = "text-dark text-decoration-none"><div class = "card my-1 bg-light border-0" id = "' + trimTag + i + '"><div class = "card-body"></div></div></a>');
